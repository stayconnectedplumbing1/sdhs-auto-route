...
const SUBURBS: Record<string, { x: number; y: number }> = {
  ...
  "Hunters Hill": { x: 73, y: 47 }, Westmead: { x: 44, y: 38 }, "Castle Hill": { x: 50, y: 17 }
};
...
function routePoint(item: Job | Technician): RoutePoint {
  ...
  return HOME[item.home] || sydneyGridPoint(item.latitude, item.longitude) || item;
}
